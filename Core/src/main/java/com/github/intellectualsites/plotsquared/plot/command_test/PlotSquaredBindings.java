...
final class PlotSquaredBindings extends BindingHelper {
    ...
    private static Double parseNumericInput(@Nonnull final String input) throws ParameterException {
        try {
    ...
    public Plot getPlot(final ArgumentStack context) throws ParameterException {
        ...
        final Plot plot = MainUtil.getPlotFromString(player, input, true);
        if (plot == null) {
            throw new ParameterException();
        }
        return plot;
